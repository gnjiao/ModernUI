    ...
    public class ToolBox : UserControl
    {
        ...
        */
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            ...
            if(null != _selectedTab)
            {
                if(Keys.F2 == e.KeyCode)
                {
                    ...
                    else if(null != _selectedTab.SelectedItem)
                    {
                        _selectedTab.SelectedItem.Rename();
                    }
                }
                else if(ctrlPressed && Keys.Tab == e.KeyCode)
                {
                    SwitchTabs((Keys.Shift == (ModifierKeys & Keys.Shift)));
                }
                else
                {
        ...
        protected override void OnKeyUp(KeyEventArgs e)
        {
            ...
            try
            {
                if(null != _selectedTab && null != ItemKeyUp)
                {
        ...
        public bool XmlDeSerialize(XmlElement element)
        {
            ...
            try
            {
                ...
                for(iLoop1=0;iLoop1<tabNodes.Count;iLoop1++)
                {
                    ...
                    try
                    {
                        tab.View = (ViewMode)Enum.Parse(typeof(ViewMode),tabElement.GetAttribute(Xml_ViewMode_Attr),true);
                    }
                    catch
                    {
