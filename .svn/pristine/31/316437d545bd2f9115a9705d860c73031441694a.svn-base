...
{
    /// <summary>
    /// ref: https://github.com/sethcall/async-helper
    /// https://github.com/sethcall/async-helper/blob/master/src/AsyncTcpClient/AsyncTcpClient.cs
    /// https://www.nuget.org/packages/AsyncTcpClient/
    /// some bug fixed by rein, 2016-09-08
    /// </summary>
    public class AsyncTcpClient : IDisposable
    {
        ...
        {
            get { return this.minBufferSize; }
            set { this.minBufferSize = value; }
        }
