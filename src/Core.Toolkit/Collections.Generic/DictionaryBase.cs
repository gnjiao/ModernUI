namespace Core.Collections.Generic
{
                                                         ...
                                                         IDeserializationCallback
    {
        ...
        {
            var constructor =
                    typeof(Dictionary<TKey, TValue>).GetConstructor(
            ...
            dictionary =
                    ...
                    constructor.Invoke(BindingFlags.NonPublic, null, new object[] {info, context}, null);
        }
        ...
        { 
            key.ArgumentIsNotNull("key");
            if (!(key is TKey))
            {
                throw new ArgumentException(
                        string.Format(CultureInfo.InvariantCulture, "Keys is of type {0}.", typeof(TKey)), "key");
            }
        }
        ...
        private static void VerifyValueType(object value)
        {
            if (!(value is TValue))
            {
                ...
                {
                    throw new ArgumentException(
                            string.Format(CultureInfo.InvariantCulture, "Value is of type {0}.", typeof(TValue)),
                            "value");
                }
            }
        }
