...
namespace Core.Windows.Media.Imaging
{
    public static class BitmapSourceExtensions
    {
        ...
        public static BitmapSource GetBitmapSource(this string fileName)
        {
            ...
            var uriSource = new Uri(fileName, UriKind.RelativeOrAbsolute);
        ...
        public static BitmapSourceInfo ToBitmapSourceInfo(this BitmapSource bitmapSource)
        {
        ...
        public static BitmapSourceInfo ToBgr32BppBitmapSourceInfo(this BitmapSource bitmapSource)
        {
            var info = new BitmapSourceInfo()
            {
                DpiX = bitmapSource.DpiX,
                DpiY = bitmapSource.DpiY,
                Stride = bitmapSource.PixelWidth * 4,
                PixelWidth = bitmapSource.PixelWidth,
                PixelHeight = bitmapSource.PixelHeight,
                PixelFormat = bitmapSource.Format,
            };
        ...
        public static BitmapSourceInfo ToRgb24BppBitmapSourceInfo(this BitmapSource bitmapSource)
        {
            var info = new BitmapSourceInfo()
            {
                DpiX = bitmapSource.DpiX,
