...
namespace Core.Serialization
{
    public static class SerializationTestServices
    {
        ...
        public static T Create<T>(SerializationInfo info, StreamingContext context)
        {
            ...
            {
                throw new NullReferenceException("Type does not have a private or protected serialization constructor.");
            }
        ...
        ///     Returns a new instance of <see cref="SerializationInfo"/> replacing the specified member name with the specified value.
        /// </summary>
        public static SerializationInfo CreateSerializationInfoReplacingMember<T>(
            string memberName, object value, Func<T> creator) where T : ISerializable
        {
        ...
        private static SerializationInfo CloneReplacingMember<T>(
            SerializationInfo info, string memberName, object value)
        {
            return Clone<T>(
                info,
                (entry, clone) =>
        ...
        private static SerializationInfo Clone<T>(
            SerializationInfo info, Func<SerializationEntry, SerializationInfo, bool> predicate)
        {
