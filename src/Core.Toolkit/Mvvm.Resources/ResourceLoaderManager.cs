...
namespace Core.Mvvm.Resources
{
    ...
    public class ResourceLoaderManager : IResourceLoaderManager
    {
        ...
        {
            get { return DefaultCoreResourcesDirectory; }
        }
        ...
        public void AddFolder(string folder)
        {
            ...
            try
            {
                ...
                else if (Directory.Exists(DefaultCoreResourcesDirectory + folder))
                {
                    var directoryInfo1 = new DirectoryInfo(DefaultCoreResourcesDirectory + folder);
