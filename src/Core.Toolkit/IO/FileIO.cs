...
namespace Core.IO 
{
    public static class FileIO
    {
        ...
        {
            string path = Path.Combine(GetRootTemporaryDirectory(), RandomGenerator.GenerateRandomString());
        ...
        {
            return Path.Combine(GetRootTemporaryDirectory(), RandomGenerator.GenerateRandomString() + "." + extension);
        }
    }
}
